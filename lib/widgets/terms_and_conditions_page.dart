    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSectionContent('نحتفظ بحق تعديل هذه الشروط في أي وقت، وسيتم إعلامكم بالتغييرات عبر التطبيق أو البريد الإلكتروني.'),
          _buildSectionTitle('9. الاتصال بنا'),
          _buildSectionContent(
              'لأية استفسارات أو ملاحظات، يرجى التواصل عبر:\nالبريد الإلكتروني: justmart2025@gmail.com\nالهاتف: 0775511338'),
          const SizedBox(height: 30),
          Text(
            'تاريخ آخر تحديث: 31 مايو 2025',
            style: TextStyle(
              fontSize: 14,
